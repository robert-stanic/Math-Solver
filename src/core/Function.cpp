...
// - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
// - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
std::shared_ptr<FunctionArgument> Function::operator()(std::vector<std::shared_ptr<FunctionArgument>>& arguments) {
	return std::make_shared<Expression>(this, arguments);
}
// - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
// - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
std::shared_ptr<FunctionArgument> Function::operator()(std::initializer_list<std::shared_ptr<FunctionArgument>> arguments) {
	return std::make_shared<Expression>(this, arguments);
}
// - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
// - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
Function& Function::operator=(const std::shared_ptr<FunctionArgument>& expression) {
	this->expression = expression;
	return *this;
}
// - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
// - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
std::shared_ptr<FunctionArgument> Function::get(const std::string& variableName) const {
...
// - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
Expression::Expression(const Function* function, std::vector<std::shared_ptr<FunctionArgument>>& arguments)
: function(function), arguments(arguments) { }
// - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
// - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
Expression::Expression(const Function* function, std::initializer_list<std::shared_ptr<FunctionArgument>> arguments)
: function(function), arguments(arguments) { }
// - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
// - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
